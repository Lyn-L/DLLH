function evaluation_info = evaluateADLLE(data, param)
...
S=getAnchorW(traindata,traindata(randperm(size(traindata,1),300),:),2);
traindata = traindata * pc;
[Y,R]=DLLE2(traindata,S,b_itr,s_itr,alpha);
